...
//得到链接管理
func (s *Server) GetConnMgr() eduiface.IConnManager {
	return s.ConnMgr
}
...
func (s *Server) CallOnConnStart(conn eduiface.IConnection) {
...
func (s *Server) CallOnConnStop(conn eduiface.IConnection) {
	if s.OnConnStop != nil {
